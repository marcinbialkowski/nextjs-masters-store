...
export const CartItem = ({ cartId, item }: CartItemProps) => {
  ...
  return (
    <li className="grid grid-cols-[theme(spacing.36)_1fr] grid-rows-[1fr_min-content] gap-x-6 gap-y-4 border-b border-b-gray-300 py-4 last-of-type:border-b-0 md:grid-cols-[theme(spacing.36)_min-content_1fr]">
      {image && (
